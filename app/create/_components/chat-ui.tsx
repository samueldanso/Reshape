	...
	const handleTransactionComplete = useCallback((hash: string) => {
		...
		toast.success('🎉 NFT Minted Successfully!', {
			...
			action: {
				...
				onClick: () => {
					window.open(`https://explorer-sepolia.shape.network/tx/${hash}`, '_blank')
				},
			},
		})
						...
						<div className="flex-1 space-y-4">
							...
							<div className="pt-4 border-t border-border/50">
								...
								<div className="flex flex-wrap gap-2">
									<a
										href={`https://explorer-sepolia.shape.network/tx/${generatedImage.ipfsHash}`}
										target="_blank"
										rel="noopener noreferrer"
									...
									<a
										...
										target="_blank"
										rel="noopener noreferrer"
										className="inline-flex items-center gap-2 px-3 py-2 bg-purple-100 dark:bg-blue-900/30 text-purple-700 dark:text-purple-300 text-xs font-medium rounded-lg hover:bg-purple-200 dark:hover:bg-purple-800/50 transition-colors"
									>
										<ExternalLink className="size-3" />
										IPFS Gateway
									</a>
